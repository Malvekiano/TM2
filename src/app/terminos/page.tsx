export default function TerminosPage() {
  return (
    <main className="p-6 max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        Debido a la naturaleza digital de los productos, no se aceptan devoluciones una vez realizada la entrega. No obstante, si el usuario experimenta problemas técnicos que impidan la correcta descarga o acceso al producto, puede contactarnos en un plazo máximo de 7 días desde la compra.
        <br />
        Evaluaremos cada caso individualmente y, de ser procedente, se realizará un reenvío o reembolso parcial.
      </p>
      ...
      <h2 className="text-lg font-semibold mt-6 mb-2">8. Política de privacidad y cookies</h2>
      <p className="mb-4">
        El sitio puede hacer uso de cookies propias o de terceros para mejorar la experiencia de navegación y realizar análisis de uso. Estas cookies no contienen información personal identificable.
        <br />
        Al continuar navegando por el sitio, el usuario acepta el uso de cookies conforme a esta política.
      </p>

      <h2 className="text-lg font-semibold mt-6 mb-2">9. Limitación de responsabilidad</h2>
      <p className="mb-4">
        No garantizamos que el sitio esté libre de errores o interrupciones, aunque trabajamos constantemente para mantenerlo disponible. No nos hacemos responsables por interrupciones derivadas de causas ajenas a nuestra gestión directa.
      </p>

      <h2 className="text-lg font-semibold mt-6 mb-2">10. Cambios en los términos</h2>
      <p className="mb-4">
        Nos reservamos el derecho de actualizar estos términos en cualquier momento. Las modificaciones entrarán en vigencia desde su publicación en el sitio web.
      </p>

      <h2 className="text-lg font-semibold mt-6 mb-2">11. Legislación aplicable</h2>
      <p className="mb-4">
        Este sitio se rige por las leyes de la República del Perú. Ante cualquier controversia, ambas partes se someten a la jurisdicción de los tribunales peruanos competentes.
      </p>
    </main>
  );
}
